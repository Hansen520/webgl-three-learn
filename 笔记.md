...
控制位置信息，主要是通过 attribute vec4 aPosition; 和 gl.vertexAttrib2f(aPosition, x,y)控制位置的信息
...
控制颜色信息， 主要是通过uniform vec2 uColor; 和 gl.vertexAttrib2f控制颜色的信息
